...
class App extends Component {
	...
	render() {
		...
		return ( < div >
			...
			onItemEdit = {
				this.__onHostsEdit.bind(this)
			}
			onItemClick = {
				this.__onHostsClick.bind(this)
			}
			onItemRemove = {
				this.__onHostsRemove.bind(this)
			}
			onSearchChange = {
				this.__onSearchChange.bind(this)
			}
			onAddHostsClick = {
				this.__createNewHosts.bind(this)
			}
			onUpdateHostsClick = {
				this.__onUpdateHostsClick.bind(this)
			}
			onItemStatusChange = {
			...
			/> {
				...
				onDismiss = {
					this.__onSnackDismiss.bind(this)
				}
				/> :
				null
			}
