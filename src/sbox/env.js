...
const env = ()=>{
    ...
    request('http://streamupbox.com', function (error, response, body) {
        if (!error) {
            process.env.host='https://streamupbox.com';
        }else{
