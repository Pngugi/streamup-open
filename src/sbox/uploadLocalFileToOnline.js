...
var uploadLocalFileToOnline = (function (_super) {
    ...
    uploadLocalFileToOnline.prototype.post = function (filePath) {
        ...
        try {
            request.post({ url: this.localURL(), formData: formData }, function optionalCallback(err, httpResponse, body) {
                if (err) {
